...
// ── Branding Colors ───────────────────────────────────────────────────────────
export const BRAND_PRIMARY   = import.meta.env.VITE_BRAND_PRIMARY   || "#26215C";  // navy
export const BRAND_SECONDARY = import.meta.env.VITE_BRAND_SECONDARY || "#4338A0";  // purple
export const BRAND_ACCENT    = import.meta.env.VITE_BRAND_ACCENT    || "#ED1C24";  // red

// ── Feature Flags ─────────────────────────────────────────────────────────────
// These can be overridden per client via Vercel env vars
...
// ── Helper: apply branding to document ───────────────────────────────────────
