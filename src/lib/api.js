...
export const updateEvent    = (id, data)  => apiFetch(`/api/v1/events/${id}`, { method: 'PATCH', body: JSON.stringify(data) })
...
export const updateStaff    = (id, data)  => apiFetch(`/api/v1/staff/${id}`, { method: 'PATCH', body: JSON.stringify(data) })
