            ...
            <div key={ev.id} style={{background:C.white,border:`2px solid ${C.navy}`,borderRadius:14,padding:18,cursor:"pointer",transition:"all .15s",position:"relative"}}
              ...
              <button onClick={async (e)=>{
                ...
                try {
                  ...
                  onLaunch({name:ev.name,type:ev.type,id:ev.id,cats:EX_TYPES.find(t=>t.id===ev.type)?.cats||[],dateFrom:ev.date_from,dateTo:ev.date_to,venue:ev.venue,company:ev.company,product:ev.product,industry_vertical:ev.industry_vertical||"general",industryVertical:ev.industry_vertical||"general"});
                }
              }}
            ...
            <div key={ev.id} style={{background:C.white,border:`1px solid #E2E8F0`,borderRadius:14,padding:18,cursor:"pointer",transition:"all .15s",position:"relative",opacity:0.85}}
              ...
              <button onClick={async ()=>{
                try {
                  ...
                  // Fallback to minimal data if fetch fails
                  onLaunch({name:ev.name,type:ev.type,id:ev.id,cats:EX_TYPES.find(t=>t.id===ev.type)?.cats||[],dateFrom:ev.date_from,dateTo:ev.date_to,venue:ev.venue,company:ev.company,product:ev.product,isPast:true,industry_vertical:ev.industry_vertical||"general",industryVertical:ev.industry_vertical||"general"});
                }
              }}
  ...
  return (
    <div style={{padding:24,maxWidth:1240,margin:"0 auto",fontFamily:F}}>
      ...
      <div style={{display:"flex",gap:16,alignItems:"flex-start",width:"100%",position:"relative"}}>
        ...
        {/* ── Activity Feed Panel ── */}
        <div style={{width:300,flexShrink:0,background:C.white,border:"1px solid #E2E8F0",borderRadius:14,overflow:"hidden",position:"fixed",top:80,right:24,maxHeight:"calc(100vh - 100px)",overflowY:"auto",zIndex:40}}>
          {/* Header */}
